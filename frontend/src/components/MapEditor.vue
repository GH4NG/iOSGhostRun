      ...
      <Card
        ...
        <div v-show="!isRouteCollapsed" class="max-h-[450px] overflow-hidden">
          <ScrollArea class="h-full">
            <RouteManager v-model="routePoints" @locating-point="onLocatingPoint" />
          </ScrollArea>
        </div>
      </Card>
    </div>
...
import 'ol/ol.css'
import { type RoutePoint, calculateRouteDistance, formatDistance, saveLastRoute } from '../utils/routeStorage'
...
const availableLayers = [
  ...
  { id: 'amap-vec', name: '高德-矢量', icon: Navigation },
  { id: 'amap-img', name: '高德-卫星', icon: Earth }
]

const currentLayerId = ref('osm')
